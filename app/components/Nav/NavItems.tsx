...
export function NavItem(p:{category:string,alt:string,src:StaticImageData}){
    ...
    return <Link href={"/articles/category/" + p.category} className={`flex items-center h-12 p-3 gap-2 hover:bg-slate-100 transform transition hover:scale-105 rounded-xl ${isActive && "bg-orange-500"}`}>
